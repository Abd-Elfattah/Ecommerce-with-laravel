...
@endif
	 ...
	 <li>
	 @if(!Auth::check())
	 <a href="{!! url('login') !!}"  style="padding-left:30px"><span class="btn btn-success">Sign-in</span></a>
	  @endif
	  </li>
...
<!-- Sidebar ================================================== -->
	...
	@if(Auth::check())
		<div class="well well-small"><a id="myCart" href="{{url('Eco-home/cart')}}"><img src="{{ asset('themes/images/ico-cart.png') }}" alt="cart">
		<span class="new-cart-update">{{ Session::has('cart_id') ? count(Session::get('cart_id')) : "No"}}</span> Items in cart 
	@else
		<div class="well well-small"><a id="myCart" href="{{url('/login')}}"><img src="{{ asset('themes/images/ico-cart.png') }}" alt="cart">
		<span class="new-cart-update">{{ (Session::has('cart_id')) ? count(Session::get('cart_id')) : "No"}}</span> Items in cart
	@endif

		
			<!-- <span class="badge badge-warning pull-right">{{ Session::has('totall_price') ? Session::get('totall_price') : "" }} EGP</span> -->
